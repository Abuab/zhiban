...
> **版本：v1.0**
> 本文件是小程序端 `/pages/privacy/privacy` 页面正文的唯一来源，两者必须逐字一致。
> 版本号同源变更点：`miniprogram/src/constants/privacy.ts`、`server/src/common/constants/privacy.ts`、本文件。
> 规格依据：`docs/constitution.md` §2.4、规范增补 v0.3 §3.3。

---

## 一、我们收集哪些信息

为提供测评与报告服务，我们仅收集以下必要信息：
...
如你对本政策有任何疑问，或需要行使上述权利，可通过小程序内的客服入口与我们联系。
